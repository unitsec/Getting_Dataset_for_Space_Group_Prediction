...
mp_path = os.path.expanduser('~/database_mp_mpi_bank5_cleaned')
bravias_list = ['SC','BCC','FCC']
...
for sg_num in wanted_spacegroup:
    ...
    count = 0
    for length in np.arange(a_min, a_max, 0.05):
        a = length
        b = length
        c = length
        alpha = 90
...
save_h5('standard_dataset_cubic_1020_0.05_30intlorentz.h5',samples,labels)
save_h5('standard_trainset_cubic_1020_0.05_30intlorentz.h5',samples_train,labels_train)
save_h5('standard_validationset_cubic_1020_0.05_30intlorentz.h5',samples_validation,labels_validation)
save_h5('standard_testset_cubic_1020_0.05_30intlorentz.h5',samples_test,labels_test)

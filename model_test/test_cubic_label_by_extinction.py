...
weights_PATH = "model_ULBD_cubic_label_by_extinction.weights.h5"
# weights_PATH = "model_CDDD_cubic_label_by_extinction.weights.h5"
#####################################################################################################################
...
c14 = layers.Conv1D(filters=17, kernel_size=1, strides=1, padding='same', kernel_initializer=initializer)(p13)
...
y_test_sg_onehot = tf.keras.utils.to_categorical(y_test_sg, num_classes=17)

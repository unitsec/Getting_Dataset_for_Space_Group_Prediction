...
test_File_Path = "testset_trigonal_hexagonal_fromULBD.h5"
weights_PATH = "model_ULBD_trigonal_hexagonal.weights.h5"
#####################################################################################################################
...
c14 = layers.Conv1D(filters=52, kernel_size=1, strides=1, padding='same', kernel_initializer=initializer)(p13)
...
y_test_sg = stack_test[:, -1] - 143
y_test_sg_onehot = tf.keras.utils.to_categorical(y_test_sg, num_classes=52)

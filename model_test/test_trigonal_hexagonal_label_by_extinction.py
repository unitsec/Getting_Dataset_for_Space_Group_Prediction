...
test_File_Path = "testset_trigonal_hexagonal_fromCDDD_label_by_extinction.h5"
# test_File_Path = "testset_trigonal_hexagonal_fromULBD_label_by_extinction.h5"

weights_PATH = "model_ULBD_trigonal_hexagonal_label_by_extinction.weights.h5"
# weights_PATH = "model_CDDD_trigonal_hexagonal_label_by_extinction.weights.h5"
#####################################################################################################################
...
c14 = layers.Conv1D(filters=9, kernel_size=1, strides=1, padding='same', kernel_initializer=initializer)(p13)
...
y_test_sg = stack_test[:, -1]
y_test_sg_onehot = tf.keras.utils.to_categorical(y_test_sg, num_classes=9)
